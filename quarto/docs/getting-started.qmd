...
This command starts a development environment that allows you to actually being writing code and analyzing data. By default the command begins two processes:
