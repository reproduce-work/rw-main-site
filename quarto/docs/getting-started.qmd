...
2. Install to your current directory. This creates a folder in your current directory named `rw-project`; with this choice, the `rw` command line tools can only be executed at the root of your projec't directory. 
...
<ul>
<li><span class="file">requirements.txt (or packages.R)</span></li>
</ul>
</li>
</li>
